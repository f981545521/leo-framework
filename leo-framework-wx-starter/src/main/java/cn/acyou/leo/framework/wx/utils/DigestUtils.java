...
/**
 * @author fangyou
 * @version [1.0.0, 2021-08-04 10:13]
 */
public class DigestUtils {
    ...
    public static String sha1DigestAsHex(String data) {
        byte[] dataBytes = getDigest().digest(data.getBytes(UTF8_CHARSET));
    ...
    private static MessageDigest getDigest() {
        try {
            ...
            throw new IllegalStateException("Could not find MessageDigest with algorithm \"" + "SHA" + "\"", ex);
        }
    }
}
