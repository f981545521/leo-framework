package cn.acyou.leo.framework.wx.utils;
...
public class HttpUtil {
    ...
    private static List<NameValuePair> convertParameters(Map<String, String> params) {
    ...
    public static HttpUtil getHttp(String url, Map<String, String> paramMap, Map<String, String> headerMap) {
    ...
    public static HttpUtil postHttp(String url, Map<String, String> paramMap, Map<String, File> fileMap,
    ...
    public static String postJson(String url, Map<String, String> jsonParamMap) {
        return postJson(url, JSON.toJSONString(jsonParamMap), null);
    }
    ...
    public static String postFile(String url, Map<String, String> paramMap, Map<String, File> fileMap) {
        HttpUtil httputil = postHttp(url, paramMap, fileMap, null);
        return httputil.execute().getString();
    }

    public static String postFile(String url, Map<String, String> paramMap, File file) {
        Map<String, File> fileMap = new HashMap<>(1);
        fileMap.put(file.getName(), file);
        HttpUtil httputil = postHttp(url, paramMap, fileMap, null);
        return httputil.execute().getString();
    ...
    public static String postFile(String url, Map<String, String> paramMap, List<File> fileList) {
    ...
    public static HttpUtil putHttp(String url, Map<String, String> paramMap, Map<String, File> fileMap,
                                   Map<String, String> headerMap) {
        HttpUtil httpUtil = newInstance();
    ...
    public static String put(String url, Map<String, String> paramMap, Map<String, String> headerMap) {
