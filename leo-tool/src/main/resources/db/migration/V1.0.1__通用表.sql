...
INSERT INTO `sys_param_config` (`id`, `namespace`, `code`, `value`, `ext_value`, `is_system`, `name`, `description`,
                                `status`, `remark`, `sort`, `deleted`, `create_time`, `create_user`, `update_time`,
                                `update_user`)
VALUES (100, 'icon', '抖音', 'https://vshow.guiji.ai/nfs/tici/icon/douyin.png', NULL, 0, '', '短视频平台图标', 1, NULL, NULL, 0,
        '2024-09-13 14:38:03', NULL, NULL, NULL);
INSERT INTO `sys_param_config` (`id`, `namespace`, `code`, `value`, `ext_value`, `is_system`, `name`, `description`,
                                `status`, `remark`, `sort`, `deleted`, `create_time`, `create_user`, `update_time`,
                                `update_user`)
VALUES (101, 'icon', '小红书', 'https://vshow.guiji.ai/nfs/tici/icon/xiaohongshu.png', NULL, 0, '', '短视频平台图标', 1, NULL,
        NULL, 0, '2024-09-13 14:38:03', NULL, NULL, NULL);
INSERT INTO `sys_param_config` (`id`, `namespace`, `code`, `value`, `ext_value`, `is_system`, `name`, `description`,
                                `status`, `remark`, `sort`, `deleted`, `create_time`, `create_user`, `update_time`,
                                `update_user`)
VALUES (102, 'icon', '快手', 'https://vshow.guiji.ai/nfs/tici/icon/kuaishou.png', NULL, 0, '', '短视频平台图标', 1, NULL, NULL,
        0, '2024-09-13 14:38:03', NULL, NULL, NULL);
...
VALUES (1132, '测试', '10', 1131, 1, NULL, 1, NULL, now(), now());
INSERT INTO `sys_dict`
